...
let ExperienceItemComponent = class ExperienceItemComponent {
};
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
...
let LibrariesComponent = class LibrariesComponent {
    constructor(router) {
        this.router = router;
...
LibrariesComponent.ctorParameters = () => [
...
let OpenSourceItemComponent = class OpenSourceItemComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let OpenSourceComponent = class OpenSourceComponent {
    constructor() { }
    ngOnInit() {
    }
};
